...
This tiny project follows [GitHub community trend](https://github.com/sindresorhus/awesome) ⭐ 506,614 | 🐛 106 | 📅 2026-09-02 to aggregate the most essential bookmarks for specific subject in the form of a handy well-structured collection. Here you will find tutorials and learning materials for Sublime Text, general purpose extensions for coding and text editing, and specialized extensions grouped by usage profiles.
...
* [Sublime Alignment](https://github.com/wbond/sublime_alignment) ⭐ 518 | 🐛 45 | 🌐 Python | 📅 2022-10-18 — a simple key-binding for aligning multi-line and multiple selections.
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,236 | 🐛 150 | 🌐 Python | 📅 2026-09-15 — a Python refactoring library.
...
* [JavaScript Enhancements](https://github.com/pichillilorenzo/JavaScriptEnhancements) ⭐ 641 | 🐛 27 | 🌐 Python | 📅 2024-01-31 — plugin that offers smart javascript autocomplete, real-time errors and, also, a lot of features about creating, developing and managing javascript projects (such as Cordova, Ionic, React, etc.). It uses [Flow](https://github.com/facebook/flow) ⭐ 22,289 | 🐛 515 | 🌐 Rust | 📅 2026-09-16 (javascript static type checker from Facebook) under the hood.
...
* [Material theme](https://github.com/equinusocio/material-theme) ⭐ 11,306 | 🐛 0 | 📅 2026-06-28 — This theme brings the Material Design visual language. <http://equinsuocha.io/material-theme>
...
There are a lot of other bookmarks collections on GitHub. Take a look at metabookmarks list: <https://github.com/sindresorhus/awesome> ⭐ 506,614 | 🐛 106 | 📅 2026-09-02
