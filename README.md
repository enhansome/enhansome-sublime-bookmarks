...
This tiny project follows [GitHub community trend](https://github.com/sindresorhus/awesome) ⭐ 502,914 | 🐛 106 | 📅 2026-09-02 to aggregate the most essential bookmarks for specific subject in the form of a handy well-structured collection. Here you will find tutorials and learning materials for Sublime Text, general purpose extensions for coding and text editing, and specialized extensions grouped by usage profiles.
...
**[Fork and edit](https://github.com/dreikanter/sublime-bookmarks/edit/master/README.md) ⭐ 1,076 | 🐛 1 | 📅 2024-01-15** (or [propose something](https://github.com/dreikanter/sublime-bookmarks/issues/new) ⭐ 1,076 | 🐛 1 | 📅 2024-01-15 to add).
...
* [GitGutter](https://github.com/jisaacks/GitGutter) ⭐ 3,878 | 🐛 9 | 🌐 Python | 📅 2026-03-21 — a plugin to see git diff in gutter.
* [Sidebar Enhancements](https://github.com/titoBouzout/SideBarEnhancements) ⭐ 2,222 | 🐛 8 | 🌐 Python | 📅 2026-07-17 — provides enhancements to the operations on Sidebar of Files and Folders.
...
* [Anaconda](https://github.com/DamnWidget/anaconda) ⭐ 2,241 | 🐛 185 | 🌐 Python | 📅 2022-08-12 — autocompletion, code linting, IDE features, autopep8 formating, McCabe complexity checker and Vagrant for Sublime Text 3 using Jedi, PyFlakes, pep8, PyLint, pep257 and McCabe that will never freeze your Sublime Text.
* [Rope](https://github.com/python-rope/rope) ⭐ 2,235 | 🐛 146 | 🌐 Python | 📅 2026-08-25 — a Python refactoring library.
...
* [Djaneiro](https://github.com/squ1b3r/Djaneiro) ⭐ 852 | 🐛 10 | 🌐 Python | 📅 2024-12-31 — Django support.
...
* [JavaScript Enhancements](https://github.com/pichillilorenzo/JavaScriptEnhancements) ⭐ 641 | 🐛 27 | 🌐 Python | 📅 2024-01-31 — plugin that offers smart javascript autocomplete, real-time errors and, also, a lot of features about creating, developing and managing javascript projects (such as Cordova, Ionic, React, etc.). It uses [Flow](https://github.com/facebook/flow) ⭐ 22,283 | 🐛 527 | 🌐 Rust | 📅 2026-09-04 (javascript static type checker from Facebook) under the hood.
...
* [HTMLPrettify](https://github.com/victorporof/Sublime-HTMLPrettify) ⭐ 1,948 | 🐛 125 | 🌐 JavaScript | 📅 2023-10-12
...
* [LaTeXTools](https://github.com/SublimeText/LaTeXTools) ⭐ 2,022 | 🐛 64 | 🌐 Common Workflow Language | 📅 2026-07-30 — an open-source plugin that simplifies working with LaTeX files.
...
* [MarkdownEditing](https://github.com/SublimeText-Markdown/MarkdownEditing) ⭐ 3,325 | 🐛 47 | 🌐 Python | 📅 2026-08-21 — powerful Markdown package for Sublime Text with better syntax understanding and good color schemes.
...
* [DashDoc](https://github.com/farcaller/DashDoc) ⭐ 1,318 | 🐛 5 | 🌐 Python | 📅 2026-01-11 — [Dash](https://kapeli.com/dash) integration for Sublime Text.
* [HowDoI](https://github.com/azac/sublime-howdoi-direct-paste) ⭐ 217 | 🐛 1 | 🌐 Python | 📅 2013-12-30 — integration for instant [coding answers search tool](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 28 | 🌐 Python | 📅 2026-04-15.
...
* [Material theme](https://github.com/equinusocio/material-theme) ⭐ 11,313 | 🐛 0 | 📅 2026-06-28 — This theme brings the Material Design visual language. <http://equinsuocha.io/material-theme>
...
* [Base 16](https://github.com/chriskempson/base16) ⭐ 963 | 🐛 1 | 📅 2023-10-12 — carefully chosen syntax highlighting and a default set of sixteen colors.
...
* [Adobe Source Code Pro](https://github.com/adobe-fonts/source-code-pro) ⭐ 20,446 | 🐛 87 | 🌐 CSS | 📅 2025-10-28
...
There are a lot of other bookmarks collections on GitHub. Take a look at metabookmarks list: <https://github.com/sindresorhus/awesome> ⭐ 502,914 | 🐛 106 | 📅 2026-09-02
