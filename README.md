...
This tiny project follows [GitHub community trend](https://github.com/sindresorhus/awesome) ⭐ 496,754 | 🐛 100 | 📅 2026-06-30 to aggregate the most essential bookmarks for specific subject in the form of a handy well-structured collection. Here you will find tutorials and learning materials for Sublime Text, general purpose extensions for coding and text editing, and specialized extensions grouped by usage profiles.
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,232 | 🐛 140 | 🌐 Python | 📅 2026-08-16 — a Python refactoring library.
...
* [JavaScript Enhancements](https://github.com/pichillilorenzo/JavaScriptEnhancements) ⭐ 641 | 🐛 27 | 🌐 Python | 📅 2024-01-31 — plugin that offers smart javascript autocomplete, real-time errors and, also, a lot of features about creating, developing and managing javascript projects (such as Cordova, Ionic, React, etc.). It uses [Flow](https://github.com/facebook/flow) ⭐ 22,275 | 🐛 524 | 🌐 Rust | 📅 2026-08-17 (javascript static type checker from Facebook) under the hood.
...
* [HTMLPrettify](https://github.com/victorporof/Sublime-HTMLPrettify) ⭐ 1,948 | 🐛 124 | 🌐 JavaScript | 📅 2023-10-12
...
* [LaTeXTools](https://github.com/SublimeText/LaTeXTools) ⭐ 2,022 | 🐛 63 | 🌐 Common Workflow Language | 📅 2026-07-30 — an open-source plugin that simplifies working with LaTeX files.
...
* [MarkdownEditing](https://github.com/SublimeText-Markdown/MarkdownEditing) ⭐ 3,317 | 🐛 46 | 🌐 Python | 📅 2026-08-14 — powerful Markdown package for Sublime Text with better syntax understanding and good color schemes.
...
* [Adobe Source Code Pro](https://github.com/adobe-fonts/source-code-pro) ⭐ 20,431 | 🐛 86 | 🌐 CSS | 📅 2025-10-28
...
There are a lot of other bookmarks collections on GitHub. Take a look at metabookmarks list: <https://github.com/sindresorhus/awesome> ⭐ 496,754 | 🐛 100 | 📅 2026-06-30
